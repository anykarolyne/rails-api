...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { datefrom: @travel.datefrom, dateto: @travel.dateto, from: @travel.from, price: @travel.price, to: @travel.to } }, as: :json
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { datefrom: @travel.datefrom, dateto: @travel.dateto, from: @travel.from, price: @travel.price, to: @travel.to } }, as: :json
    assert_response 200
  end
